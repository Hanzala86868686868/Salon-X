...
<div class="container">
        <div class="form-area">
            ...
            <label>
            <input class="input" type="date" name="Date" placeholder="" required value="<?php echo $date  ?>">
            <span>Date</span>
            </label>
            <label>
            <input class="input" type="time" name="Time" placeholder="" required value="<?php echo $time  ?>">
            <span>Time</span>
            </label>
            <label>
            <input class="input" type="Category" name="Category" placeholder="" required value="<?php echo $category  ?>">
            <span>Category</span>
            </label>
...
if (isset($_POST['button'])) {
   ...
   $updatequery="UPDATE `appointment` SET `ID`='$id',`Name`='$name',`Phone Numer`='$phonenumber',
   `Email`='$email',`Date`='$date',`Time`='$time',`Category`='$category' WHERE id=$id";
